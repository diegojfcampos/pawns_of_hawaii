...
if (!$getTestimonialResult) {
    ...
    while ($user_data = mysqli_fetch_array($getTestimonialResult)) {
        ...
        echo "<td><input type='checkbox' name='selected_testimonials' value='" . "' class='checkbox-visible'" . ($user_data['visible'] ? "checked" : "") . " disabled></td>";
        echo "<td><input type='checkbox' name='selected_testimonials[]' value='" . $user_data['testimonialid'] . "' class='checkbox-visible'></td>";       
        echo "</tr>";
